<template>
    <header class="qm-header">
        ...
        <div class="qm-header-tabs">
            <a-menu mode="horizontal" v-model="selectedKeys">
            ...
            this.menuData.some((n, i) => {
                if (_routePath.includes(n.path)){
                    ...
                    if (n.children != undefined){
                        this.$store.commit('SET_SYSTEM_MANAGEMENT_ASIDE_MENU_DATA', n.children);
                    } else {
                        this.$store.commit('SET_SYSTEM_MANAGEMENT_ASIDE_MENU_DATA', []);
                    }
                    return true;
    ...
    .qm-header {
        ...
        &-tabs{
            ...
            .ant-menu-item,.ant-menu-submenu{
                ...
                &:hover,&.ant-menu-item-active,&.ant-menu-item-selected,&.ant-menu-submenu-active,&.ant-menu-submenu-selected{
                    border: 0 none;
                }
                &:hover,&.ant-menu-item-active,&.ant-menu-submenu-active{
